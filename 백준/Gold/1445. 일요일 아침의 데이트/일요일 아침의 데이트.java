    ...
    static class DateCourse implements Comparable<DateCourse> {
        ...
        public String toString() {
            return "DateCourse{" +
                    "r=" + r +
                    ", c=" + c +
                    ", garbagePassing=" + garbagePassing +
                    ", garbageAdj=" + garbageAdj +
                    '}';
        }
    }
...
//        debug(dist);
    ...
    static void debug(int[][][] dist) {
        System.out.println("passingGarbage");
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < M; j++) {
                if (dist[i][j][0] == Integer.MAX_VALUE)
                    System.out.print("- ");
                else
        ...
        System.out.println("adjGarbage");
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < M; j++) {
                if (dist[i][j][1] == Integer.MAX_VALUE)
                    System.out.print("- ");
                else
