...
public class Solution_pro_14616_승강제리그 {
    private static Scanner sc;
    private static UserSolution_pro_14616_승강제리그 usersolution = new UserSolution_pro_14616_승강제리그();
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.setIn(new java.io.FileInputStream("res/input_pro_14616.txt"));
