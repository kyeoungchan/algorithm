...
public class Solution_bj_21939_문제추천시스템Version2_treeset {
	...
	public static void main(String[] args) throws Exception {
		...
		TreeSet<Node> recommendList = new TreeSet<>();
		...
		for (int i = 0; i < M; i++) {
			...
			if (op.equals("add")) {
				...
				Node rec;
				if (select == 1) rec = recommendList.last();
				else rec = recommendList.first();
